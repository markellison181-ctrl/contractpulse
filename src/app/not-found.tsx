    ...
    <div className="min-h-[70vh] flex items-center justify-center px-6">
      <div className="text-center max-w-lg">
        ...
        <p className="text-gray-400 mb-8 leading-relaxed">
          This contract may have been awarded elsewhere. Let&apos;s get you back to the intelligence that matters.
        </p>
        ...
        <div className="mt-10 flex justify-center gap-6 text-sm">
          <Link href="/archive" className="text-gray-400 hover:text-gold transition-colors">Archive</Link>
          <Link href="/blog" className="text-gray-400 hover:text-gold transition-colors">Blog</Link>
