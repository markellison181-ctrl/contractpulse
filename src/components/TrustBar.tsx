...
export default function TrustBar() {
  return (
    <section className="py-16 bg-forest-500 border-y border-forest-50/10">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-4xl mx-auto">
            {governmentSources.map((source) => (
              <GovSourceLogo key={source} name={source} />
            ))}
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-forest-50/20">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="space-y-2">
              ...
              <div className="text-gray-400 text-sm">
                Automated monitoring of all major procurement portals
              </div>
            </div>
          </div>
        </div>
