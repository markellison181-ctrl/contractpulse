...
const stats: StatItem[] = [
  {
    value: "$650B",
    label: "in federal spending tracked",
    prefix: "$",
    suffix: "B+",
    animatedValue: 650,
  },
  {
    value: "10,000",
    label: "contract awards monitored monthly",
    animatedValue: 10000,
  },
  {
    value: "500",
    label: "government contractors served",
    suffix: "+",
    animatedValue: 500,
  },
];
...
export default function AnimatedStats() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-forest-500 relative overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight">
            Powering smarter <span className="text-gold">government contracting</span>
          </h2>
          <p className="text-gray-400 max-w-2xl mx-auto">
            ContractPulse processes massive amounts of federal procurement data to give you
        ...
        <div className="mt-16 pt-8 border-t border-forest-50/20">
          <div className="grid md:grid-cols-2 gap-8 text-center">
            <div className="space-y-2">
              <div className="text-lg font-semibold text-white">Real-time Processing</div>
              <div className="text-gray-400 text-sm">
                Data refreshed every 6 hours from official sources
              </div>
            </div>
            <div className="space-y-2">
              <div className="text-lg font-semibold text-white">Professional Network</div>
              <div className="text-gray-400 text-sm">
                Trusted by contractors, consultants, and procurement professionals
              </div>
            </div>
          </div>
        </div>
